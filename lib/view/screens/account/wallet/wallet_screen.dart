...
import 'package:mohtaref/view/screens/account/wallet/wallet_today.dart';
import 'package:mohtaref/view/screens/account/wallet/wallet_weekly.dart';
          ...
          builder: (context, state) {
            ...
            return DefaultTabController(
              ...
              child: Scaffold(
                ...
                body: TabBarView(
                  children: [WalletToday(), WalletWeekly()],
                ),
              ),
            );
          });
